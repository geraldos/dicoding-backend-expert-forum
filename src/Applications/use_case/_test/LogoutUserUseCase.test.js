...
describe('LogoutUserUseCase', () => {
  it('should throw error if use case payload not contain refresh token', async () => {
    ...
    await expect(logoutUserUseCase.execute(useCasePayload))
      .rejects
      .toThrowError(ERR_DELETE_AUTHENTICATION_USE_CASE_NOT_CONTAIN_REFRESH_TOKEN)
  })
  ...
  it('should throw error if refresh token not string', async () => {
    ...
    await expect(logoutUserUseCase.execute(useCasePayload))
      .rejects
      .toThrowError(ERR_DELETE_AUTHENTICATION_USE_CASE_NOT_MEET_DATA_TYPE_SPECIFICATION)
  })
